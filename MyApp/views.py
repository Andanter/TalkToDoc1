...
@login_required #for someone to access the patients' dashboard, they should be logged in
def patient_dashboard(request):
    ...
    return render(request, 'MyApp/patient_dashboard.html', context=mydict) #rendering what we have from the DB to html
